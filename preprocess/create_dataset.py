...
def create_MIMIC_dataset(input_path):
    ...
    # exclude patients who have transferred to another ICU
    ...
    # Filter down patients to those who have not been transferred
    small_patients = patients[patients.SUBJECT_ID.isin(temp.SUBJECT_ID)]
    # Combine icustays and patients
    ...
    temp['age'] = age
    # Filter down to adults 18 and older
    temp = temp[temp.age >= 18]
    print('length of temp  :', len(temp))

    # Calculate readmission label
